...
require (
	...
	github.com/perun-network/perun-libp2p-wire v0.0.0-20240508112702-80ae10bc29e6
	github.com/stretchr/testify v1.9.0
	perun.network/go-perun v0.10.6
	perun.network/perun-ckb-backend v0.0.0-20240508125650-5cc99c189424
	perun.network/perun-demo-tui v0.0.0-20240514124818-b0c2bf2900ec
